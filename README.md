...
This project demonstrates how adaptive testing systems can combine statistical models with modern AI tools to create more personalized learning experiences.

The prototype shows how a student's ability can be estimated dynamically while simultaneously generating targeted learning recommendations using large language models.
